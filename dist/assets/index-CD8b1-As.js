const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/diagramBackend-B16o2naC.js","assets/mermaid-DUpwj47y.js","assets/react-vendor-KfUPlHYY.js"])))=>i.map(i=>d[i]);
import{r as T,a as ot,R as Ee}from"./react-vendor-KfUPlHYY.js";import{_ as Ae,m as Qe}from"./mermaid-DUpwj47y.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))a(m);new MutationObserver(m=>{for(const p of m)if(p.type==="childList")for(const v of p.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&a(v)}).observe(document,{childList:!0,subtree:!0});function n(m){const p={};return m.integrity&&(p.integrity=m.integrity),m.referrerPolicy&&(p.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?p.credentials="include":m.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function a(m){if(m.ep)return;m.ep=!0;const p=n(m);fetch(m.href,p)}})();var Ze={exports:{}},$e={};/**
 * @license React

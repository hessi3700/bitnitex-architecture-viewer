...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-c83219d4-6ZWP2CW7.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-50d868cf-JYO7LHE4.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-4f6560a1-STR7OQV3.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-0228fc6a-ZFAIJEQS.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-82fe8481-3LUBHOSO.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-a2739b55-YAV5SWIA.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-8eee0895-AOB4D44W.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-a8764435-ZBBZSANV.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-1e28029f-YO2G35D6.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-f5964ef8-BAMTGS4A.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-08caed73-OBWX3MPG.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-c5b8d532-TF22MARZ.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-beda092f-G33CB3YZ.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-2358418a-DMMPD3ZE.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-1ecb1508-IB2LHBTF.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-c2b004d7-K6FP64AN.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-c64418c1-KCJRGYBE.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-6af322e1-RK42IIKM.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-faaaa080-UYKELIM2.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-8da855dc-OJOAPGYK.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-a04cb91d-WTFKTM67.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-c4efeb88-42Z3TR3A.js");
...
mermaid/dist/mermaid-7ea9cbd6.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EPBSBZWL.js.map
